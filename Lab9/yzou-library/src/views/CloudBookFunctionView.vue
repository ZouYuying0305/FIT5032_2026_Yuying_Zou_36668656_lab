    ...
    <section class="card shadow-sm">
      <div class="card-body">
        ...
        <p class="text-muted">
          ...
          Function. The cloud function returns the book count, top ISBN records, and a sales
          insight summary.
        </p>

        <button class="btn btn-primary" type="button" :disabled="loading" @click="callCloudFunction">
